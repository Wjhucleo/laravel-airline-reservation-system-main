...
<div class="card">
 ...
 <div class="card">
    ...
    <div class="card form-container">
        ...
        <div class="card-body">
          <form action="{{ route('customsDeclaration.store') }}" method="POST">
            @csrf
            <input type="text" name="full_name" placeholder="Nom Complet" value="{{ old('full_name', $user->name) }}" required>
            <input type="text" name="passport_number" placeholder="Numéro de Passeport" required>
            <textarea name="declaration_details" rows="5" placeholder="Détails de la Déclaration" required></textarea>
            <button class="btn btn-primary w-sm" type="submit">Soumettre la Déclaration</button>
          </form>
        </div>
    </div>
    </div>
