...
@section('css')
  ...
  <!-- Custom CSS for Softer White Background -->
  <style>
   body {
    background-color: #2c2c2c; /* Dark background for the entire page */
    color: #f5f5f5cc; /* Light text color */
  }

  .card {
    background-color: #f5f5f5cc; /* Softer white background for cards */
    color: #333; /* Dark text color within the cards */
  }

  .table {
    background-color: #f5f5f5cc; /* White background for tables */
    color: #333; /* Dark text color for the table content */
  }

  .table-light {
    background-color: #f5f5f5cc; /* Slightly lighter background for table header */
  }

  .table-light th, .table-light td {
    color: #333; /* Dark text for table headers and cells */
  }

  .badge-pill {
    background-color: #f5f5f5cc; /* Softer background color for badges */
              ...
              <div class="d-flex">
                ...
                <div class="align-self-center flex-shrink-0">
                  <div class="mini-stat-icon avatar-sm rounded-circle bg-primary">
                    <span class="avatar-title" style="background-color:  #264e86; color: #ffffff; ">
              ...
              <div class="d-flex">
                ...
                <div class="align-self-center flex-shrink-0">
                  <div class="avatar-sm rounded-circle bg-primary mini-stat-icon">
                    <span class="avatar-title rounded-circle " style="background-color:  #264e86; color: #ffffff; ">
                  ...
                  <tbody>
                    @forelse ($data['activeAirlines'] as $airline)
                      <tr>
                        ...
                        <td class="fw-bold" style="color: #264e86;">{{ ucfirst($airline->name) }}</td>
              ...
              <tbody>
                @forelse ($data['lastFlights'] as $flight)
                  <tr>
                    ...
                    <td class="fw-bold" style="color: #264e86;">{{ ucfirst($flight->flight_number) }}</td>
                    <td>{{ ucfirst($flight->airline->name) }}</td>
                    <td><span class="badge badge-pill badge-soft-info font-size-13" style="color: #264e86;">{{ ucfirst($flight->origin->name) }}</span></td>
                    ...
                    <td class="fw-bold" style="color: #264e86;">{{ formatPrice($flight->price) }}</td>
                  </tr>
                @empty
                  <tr>
                    <td colspan="10" class="text-center">@lang('translation.emptyTable')</td>
